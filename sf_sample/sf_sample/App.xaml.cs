...
namespace sf_sample
{
    public partial class App
    {
        ...
        private void RegisterTypesForNavigation()
        {
            ...
            Container.RegisterTypeForNavigation<LinearChartView>(typeof(LinearChartView).GetNavigationId());
            Container.RegisterTypeForNavigation<PieChartView>(typeof(PieChartView).GetNavigationId());
            Container.RegisterTypeForNavigation<BarChartView>(typeof(BarChartView).GetNavigationId());
